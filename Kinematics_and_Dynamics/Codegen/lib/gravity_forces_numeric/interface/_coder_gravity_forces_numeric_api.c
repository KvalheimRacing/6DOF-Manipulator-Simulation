 ...
 * File: _coder_gravity_forces_numeric_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "gravity_forces_numeric",            /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
 ...
 * Return Type  : void
 */
void gravity_forces_numeric_api(const mxArray * const prhs[4], const mxArray
  *plhs[1])
{
  real_T (*G)[6];
  real_T T2;
  ...
  real_T T4;
  real_T T5;
  G = (real_T (*)[6])mxMalloc(sizeof(real_T [6]));
  ...
  gravity_forces_numeric(T2, T3, T4, T5, *G);
 ...
 * Return Type  : void
 */
void gravity_forces_numeric_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  gravity_forces_numeric_xil_terminate();
}
 ...
 * Return Type  : void
 */
void gravity_forces_numeric_initialize(void)
{
  mexFunctionCreateRootTLS();
 ...
 * Return Type  : void
 */
void gravity_forces_numeric_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}
...
/*
 * File trailer for _coder_gravity_forces_numeric_api.c
 *
 * [EOF]
 */
