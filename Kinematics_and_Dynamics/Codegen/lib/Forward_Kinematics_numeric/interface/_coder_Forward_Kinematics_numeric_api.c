 ...
 * File: _coder_Forward_Kinematics_numeric_api.c
 *
...
#include "_coder_Forward_Kinematics_numeric_mex.h"
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Forward_Kinematics_numeric",        /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
 ...
 * Return Type  : void
 */
void Forward_Kinematics_numeric_api(const mxArray * const prhs[6], const mxArray
  *plhs[1])
{
  real_T (*Forward_Kinematics)[16];
  real_T T1;
  real_T T2;
  real_T T3;
  real_T T4;
  real_T T5;
  real_T T6;
  Forward_Kinematics = (real_T (*)[16])mxMalloc(sizeof(real_T [16]));
  ...
  T6 = emlrt_marshallIn(emlrtAliasP((const mxArray *)prhs[5]), "T6");

  /* Invoke the target function */
  Forward_Kinematics_numeric(T1, T2, T3, T4, T5, T6, *Forward_Kinematics);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*Forward_Kinematics);
}
 ...
 * Return Type  : void
 */
void Forward_Kinematics_numeric_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  Forward_Kinematics_numeric_xil_terminate();
}
 ...
 * Return Type  : void
 */
void Forward_Kinematics_numeric_initialize(void)
{
  mexFunctionCreateRootTLS();
 ...
 * Return Type  : void
 */
void Forward_Kinematics_numeric_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}
...
/*
 * File trailer for _coder_Forward_Kinematics_numeric_api.c
 *
 * [EOF]
 */
